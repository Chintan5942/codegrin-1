    ...
    return (
        ...
        >
          <div className="absolute top-1/5 transform text-center">
            ...
            <h1 className="text-3xl lg:text-7xl mt-2 lg:mt-3 font-bold inline-block pb-5 bg-gradient-to-b from-white from-20% to-primary to-55% bg-clip-text text-transparent">
