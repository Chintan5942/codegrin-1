              ...
              <div className="p-8 md:p-12 lg:p-16 text-white max-w-4xl">
                ...
                <div className="mb-4 flex gap-2 capitalize">
                  {project.tech_category.map((tech, index) => (
                    <span
                      key={index}
                      className="inline-flex items-center px-4 py-2 rounded-full text-sm font-medium border border-primary-light text-white backdrop-blur-sm hover:bg-primary-light/10 transition-all duration-300"
                    >
